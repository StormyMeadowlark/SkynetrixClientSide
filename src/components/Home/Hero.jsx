  ...
  return (
    <section className="relative min-h-screen flex flex-col items-center justify-center text-center overflow-hidden">
      ...
      <img
        ...
        loading="lazy"
      />
      <h1 className="text-4xl md:text-6xl font-bold text-light-purple dark:text-light-teal font-orbitron">
        Shift Gears into the Future with AI-Driven Auto Solutions
      </h1>
      <p className="text-lg md:text-2xl max-w-3xl mx-auto mt-4 font-sans">
      ...
      <Link
        to="/founders-access"
        className="mt-6 px-10 py-4 font-bold text-lg rounded-full bg-white dark:bg-purple animate-pulse hover:animate-hoverGlow hover:shadow-neon-teal transition duration-300 font-orbitron"
      >
