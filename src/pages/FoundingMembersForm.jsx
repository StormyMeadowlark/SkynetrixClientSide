...
import { Eye, EyeOff } from "lucide-react"; // Optional, or replace with your own eye icon

const FoundersAccessRegister = () => {
  ...
  useSEO({
    title: "Founders Access Sign Up",
    description:
      "Register your shop or dealership to join Skynetrix Founder's Club. Get exclusive early access perks.",
  });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // await axios.post("/api/founders/register", form);
    ...
    <main className="min-h-screen flex items-center justify-center bg-light-primary-bg dark:bg-dark-primary-bg transition-all">
      <div className="bg-white dark:bg-dark-purple text-black dark:text-white p-8 rounded-3xl shadow-lg w-full max-w-md">
        ...
        <h1 className="text-3xl font-orbitron font-bold text-center text-light-purple dark:text-light-teal mb-2">
          Register for Founders Access
        </h1>
        <p className="text-center text-gray-600 dark:text-gray-300 mb-6">
          Start your journey with exclusive early access perks
        </p>
...
export default FoundersAccessRegister;
