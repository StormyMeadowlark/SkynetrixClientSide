...
const FullThrottleAccessRegister = () => {
  ...
  useSEO({
    title: "Full Throttle Access Sign Up",
    description:
      "Register your business to unlock Skynetrix Full Throttle Access. Dive into premium tools and services for elite auto operations.",
  });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // await axios.post("/api/full-throttle/register", form);
    ...
    <main className="min-h-screen flex items-center justify-center bg-light-primary-bg dark:bg-dark-primary-bg transition-all">
      <div className="bg-white dark:bg-dark-purple text-black dark:text-white p-8 rounded-3xl shadow-lg w-full max-w-md">
        ...
        <h1 className="text-3xl font-orbitron font-bold text-center text-light-purple dark:text-light-teal mb-2">
          Register for Full Throttle Access
        </h1>
        <p className="text-center text-gray-600 dark:text-gray-300 mb-6">
          Step into the driver’s seat with elite-level tools and support
        </p>
...
export default FullThrottleAccessRegister;
